...
function ebBookmarkSyncInit() {
    ...
    if (!ebWordpressIsLoggedIn() || !window.Worker) {
        return false;
    }
    ...
    if (!sessionStorage.getItem("eb-bookmarks-synced")) {
        ...
        sessionStorage.setItem("eb-bookmarks-synced", true);
    }
...
function ebBookmarkOverloadStorageFunctions(worker) {
    ...
    Storage.prototype.setItem = function (key, value) {
        ...
        if (
            ...
            sessionStorage.getItem("eb-bookmarks-synced")
        ) {
