...
set /p process=Enter a number and hit return. 
    ...
    :printpdf
        ...
        :printpdfrefresh
            ...
            if "%subdirectory%"=="" call gulp renderIndexCommentsAsTargets --book %bookfolder% --output printpdf
            if not "%subdirectory%"=="" call gulp renderIndexCommentsAsTargets --book %bookfolder% --language %printpdfsubdirectory% --output printpdf
    ...
    :screenpdf
        ...
        :screenpdfrefresh
            ...
            :: Pre-process HTML for book indexes
            echo Creating targets for book-index references...
            if "%subdirectory%"=="" call gulp renderIndexCommentsAsTargets --book %bookfolder% --output screenpdf
            if not "%subdirectory%"=="" call gulp renderIndexCommentsAsTargets --book %bookfolder% --language %screenpdfsubdirectory% --output screenpdf
